...
<img src="https://github.com/faizan1234567/Brats-20-Tumors-segmentation/blob/main/media/gif.gif" alt="Alt Text" width="820"/>
...
### Supported Models
Each model has been trained for ```300 epochs``` on NVIDIA ```RTX-4070``` GPU by exactly following details from their papers. Model checkpoints for models or a particular model will provided on the request. 
